...
class _$OrganizerImpl implements _Organizer {
  ...
  @override
  String toString() {
    return 'Organizer(id: $id, name: $name, logo: $logo, background: $background, description: $description, cardNumber: $cardNumber, cardHolderName: $cardHolderName, facebook: $facebook, telegram: $telegram, vk: $vk, twitter: $twitter, instagram: $instagram)';
  }
